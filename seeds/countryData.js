...
const countryData = [   
    ...
    },
    {
        ...
        docText: 'Arriving travellers must complete the EU Digital Passenger Locator Form (<a href=\"https://app.euplf.eu/#/\" target=\"_blank\" rel=\"noopener\">https://app.euplf.eu/#/</a>).</p> <p>Registration is also required for travel to Puglia (<a href=\"https://www.sanita.puglia.it/web/pugliasalute/ingresso-in-puglia-da-estero\" target=\"_blank\" rel=\"noopener\">https://www.sanita.puglia.it/web/pugliasalute/ingresso-in-puglia-da-estero</a>).',
...
const countryData = () => Country.bulkCreate(countryData);
